...
{s}% Citation style: n=for numerical style, s=for numerical superscript style, a=any other letter for author–year, (default) author–year
...
\include{Contents/Table_of_contents}
...
\include{Contents/1_Introduction_and_motivation}
\include{Contents/2_Background_Diabetes_and_BGL}
\include{Contents/3_PPG}
\include{Contents/4_Anatomical_zones}
\include{Contents/5_ML}
\include{Contents/6_Deep_learning_approaches}
\include{Contents/7_Hybrid_models}
\include{Contents/8_Comparison_of_methods}
